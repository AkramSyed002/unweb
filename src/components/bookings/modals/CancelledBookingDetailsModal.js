...
const RenderReservationDetails = ({
  ...
  <Grid item container direction="column" style={{ width: 360 }}>
    ...
    <Grid
      ...
      style={{ marginTop: record.special_requirements === "" ? "15%" : "8%" }}
    >
      {!viewModeOnly && (
        <Button
          variant="text"
  ...
  <Grid item container direction="column" style={{ width: 320 }}>
    ...
    <Grid item container>
      {record &&
        ...
        record.dietary_requirements.map((el, i) => (
          <Chip key={i.toString()} label={el} className={classes.chip} />
        ))}
    </Grid>
    <Grid item container>
    ...
    <Scrollbar style={{ height: 740 }}>
      ...
      {/* {bookingConfirmationModal && (
        <BookingModal
          ...
          closeModal={handleBookingConfirmModalClose}
          bookingItem={record}
